class Travel::Journey < ActiveRecord::Base
  ...
  self.business_fields = %w[ product_id name sequence market_price adult_price child_price people_quota started_on ended_on start_time duration_time early_booking pick_up with_food introduction fee_description refund_policy other_description route tips published ]
